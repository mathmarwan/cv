...
\title{PhD in Mathematics  \& Software Engineer}                               % optional, remove / comment the line if not wanted
...
\homepage{https://mathmarwan.github.io/}                         % optional, remove / comment the line if not wanted
...
My teaching duties in Algebraic Geometry range from designing the class content, grading the assignments and exams,  choosing the right problems to illustrate the mathematical concepts, to 
...
\section{Education}
\cventry{2020-2025}{PhD in Algebraic Geometry, with honours }{Freie Universit\"{a}t Berlin}{}{{Berlin,}{\textit{Germany}}{}}{}
...
\subsection{Teaching assistant in Computer Science and Cybersecurity}
...
\cvitem
{Title}
{\href{https://refubium.fu-berlin.de/handle/fub188/49206}{\emph{Character Varieties for Seifert Groups and Higgs Bundles over Orbifolds}}}
